...
# icon
lower_frame = Frame(root , bg = "#031E5A", width = 485 , height = 180 )
#lower_frame = Frame(root , bg = "#06B75F", width = 485 , height = 180 )
